...
from G1_mimic.base.base_task import BaseTask
from G1_mimic.base.legged_robot import LeggedRobot, euler_from_quaternion
from G1_mimic.utils.math import *
from G1_mimic.base.legged_robot_config import LeggedRobotCfg
...
class H1Mimic(LeggedRobot):
    ...
    def init_motions(self, cfg):
        ...
        if cfg.motion.motion_type == "single":
            motion_file = 'data/retarget_npy/predicted_data1.npy'
        # else:
